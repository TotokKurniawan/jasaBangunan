...
const Sidebar = () => {
  ...
  return (
    <div
      className={`flex h-auto min-h-[100vh] ${
        isOpen ? "w-64" : "w-14"
      } bg-blue-800 text-white transition-all duration-300 float-left`}
    >
      <div className="flex flex-col justify-between h-auto w-full">
        <div className="flex flex-col">
          <div className="flex items-center justify-between p-4">
            <span className="text-2xl">
              <img src={Logo} alt="mx-auto" className="w-40" />
              {isOpen && ""}
            </span>
          ...
          <nav className="mt-4">
            <button
              className="flex items-center w-full p-4 hover:bg-blue-600 transition-colors focus:outline-none lg:pl-[18px]"
            ...
            >
              ...
              {isOpen && <span className="ml-4">Testimoni</span>}
            </button>
            <button
              className="flex items-center w-full p-4 hover:bg-blue-600 transition-colors focus:outline-none lg:pl-[18px]"
